...
resource "aws_security_group" "dd_dotnet_native_svc" {
...
resource "aws_instance" "dd_dotnet_native_svc" {
  ami                         = local.resolved_ami
  instance_type               = var.instance_type
  key_name                    = var.key_name
  subnet_id                   = var.subnet_id
  vpc_security_group_ids      = [aws_security_group.dd_dotnet_native_svc.id]
