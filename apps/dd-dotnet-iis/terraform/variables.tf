...
variable "ami_id" {
  description = "Windows Server 2022 AMI ID. Leave empty to use the latest Windows Server 2022 Base from SSM."
  type        = string
  default     = ""
}

variable "key_name" {
  description = "EC2 key pair name for RDP / WinRM access."
  type        = string
}
...
variable "allowed_cidr_blocks" {
  description = "CIDR blocks allowed inbound to the app ports and RDP."
  type        = list(string)
  default     = ["0.0.0.0/0"]
}
