...
variable "ami_id" {
  description = "Windows Server 2019 AMI ID. Leave empty to use the latest Windows Server 2019 Base from SSM."
  type        = string
  default     = ""
}
...
variable "allowed_cidr_blocks" {
  description = "CIDR blocks allowed inbound to port 8084 and RDP."
  type        = list(string)
  default     = ["0.0.0.0/0"]
}
